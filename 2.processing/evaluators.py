...
models = {
    ...
    "gpt5": ChatOpenAI( #gpt5
    model="gpt-5.4-pro",
    api_key=gpt_key,
    temperature=0
    ),
    "minimax": ChatOpenAI( #minimax
    model="MiniMax-M3", #change
    api_key=minimax_key,
...
#LOAD FILES
pdf_dir = "/Users/lisahabimana/Desktop/VU/Thesis/ehcp pdf"
pdf_files = sorted(Path(pdf_dir).glob("*.pdf"))

#OUPTUT DIRECTORY
OUT_DIR = Path("evaluators_FINAL")
...
#LOOP THROUGH MODEL & REPORTS THEN SAVE EVALUATIONS OF EACH MODELS
